...
function BannerUpdateSection() {
  ...
  return (
    <>
      <div className='mx-5'>
        <div className='my-10'>
          <h1 className='text-3xl font-bold'>Banner Update page</h1>
          <button className='my-5 text-lightblue '>
            <Link to='/homepages/banner' className='flex items-center space-x-2'>
        ...
        <div className=' space-y-5 text-darktext'>
          ...
          <div className=' flex w-full'>
            <div className=' w-1/2 px-2 space-y-2'>
              <div className='flex items-center space-x-2 text-lightblue'>
                ...
                <span className='text-lg'>Hero Title</span>
              </div>
              <div className=''>
                <input type='text'
          ...
          <div className=' flex '>
            <div className=' w-full px-2 space-y-2'>
              <div className='flex items-center space-x-2 text-lightblue'>
                ...
                <span className='text-lg'>Hero Description</span>
              </div>
              <div className=''>
                <input type='text'
          ...
          <div className=' flex justify-start mt-10 '>
            <button className='bg-lightblue hover:bg-blue text-white px-7 py-2 rounded-lg'>Update</button>
          </div>
