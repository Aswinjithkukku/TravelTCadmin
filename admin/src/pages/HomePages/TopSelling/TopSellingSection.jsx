...
import TopSellingAddModal from './TopSellingAddModal'
        ...
        <>
            <div className='mx-4'>
                <div className='space-y-4'>
                    <div className=' my-10'>
                        <h1 className='text-3xl font-bold text-darktext'>Top Selling</h1>
            ...
            {view && (
                <TopSellingAddModal view={view} setView={setView} />
            )}
        </>
    )
}
