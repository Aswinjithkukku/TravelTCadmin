...
function UpdateCategoryModal({ view, setView }) {
    ...
    const { categoryToUpdate } = useSelector(state => state.category)
    ...
    const submitHandler = async(e) => {
        ...
        try {
            ...
            const response = await axios.patch(`/attractions/categories/update/${categoryToUpdate?._id}`, data, config)
                        ...
                        <form onSubmit={submitHandler}>
                            <div className='p-7 space-y-4'>
                                ...
                                <div className=' flex justify-end mt-10 mr-10'>
                                    <button type='submit' className='bg-lightblue hover:bg-blue text-white px-5 py-2 rounded-lg'>Update</button>
                                </div>
