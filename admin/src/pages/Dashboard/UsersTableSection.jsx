    ...
    <table className='table w-full border-separate border-spacing-2 border border-slate-500'>
      <thead>
        <tr>
          ...
          <th className='py-3 text-left text-lg font-semibold px-2 text-lightblue'>email</th>
          <th className='py-3 text-left text-lg font-semibold px-2 text-lightblue'>role</th>
      ...
      <tbody>
        <tr className='group cursor-pointer bg-soft' >
          ...
          <td className='py-3 px-2 text-left font-light group-hover:text-lightblue text-darktext'>Sam</td>
          <td className='py-3 px-2 text-left font-light group-hover:text-lightblue text-darktext'>
            <span className='bg-lightblue px-4 text-white rounded-md'>sam@email.com</span>
          </td>
          <td className='py-3 px-2 text-left font-light group-hover:text-lightblue text-darktext'>
            <span className='bg-lightblue px-4 text-white rounded-md'>admin</span>
          </td>
