...
import booking2 from "../../static/booking2.png"
    ...
    return (
        <div className='py-10 '>
            <div className='grid grid-cols-3 gap-10 w-full'>
                <div className=' bg-soft hover:bg-[#2192FF] text-darktext  rounded-xl px-7 pt-7 pb-3 space-y-5 cursor-pointer'>
                    <div className='flex items-center justify-center'>
                        <img src={booking} alt='img' className='h-20 ' />
                    </div>
                    <div className='flex justify-center items-center'>
                        <h2 className='text-2xl font-bold'>Total Booking Recieved</h2>
                    </div>
                    <div className='flex justify-center items-center'>
                ...
                <div className=' bg-soft hover:bg-[#2192FF] text-darktext rounded-xl px-7 pt-7 pb-3 space-y-5 cursor-pointer'>
                    <div className='flex items-center justify-center'>
                        <img src={booking2} alt='img' className='h-20 ' />
                    </div>
                    <div className='flex justify-center items-center'>
                        <h2 className='text-2xl font-bold'>Total Booking Confirmed</h2>
                    </div>
                    <div className='flex justify-center items-center'>
                ...
                <div className=' bg-soft hover:bg-[#2192FF] text-darktext rounded-xl px-7 pt-7 pb-3 space-y-5 cursor-pointer'>
                    ...
                    <div className='flex justify-center items-center'>
                        <h2 className='text-2xl font-bold'>Total Booking Cancelled</h2>
                    </div>
                    <div className='flex justify-center items-center'>
